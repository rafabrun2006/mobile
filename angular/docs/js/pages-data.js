...
angular.module('pagesData', [])
  ...
  "api/ng/directive/ngSrc": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api attribute attrs browser buggy correct directive doesn expression fetch gravatar html http _img inside js js-angular-release literal markup ng ng-src ngattributealiasdirectives ngsrc problem replaces solves src string text url work write"
    }
  },
  "api/ng/directive/ngSrcset": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api attribute attrs browser buggy correct directive doesn expression fetch gravatar html http _img inside js js-angular-release literal markup ng ng-srcset ngattributealiasdirectives ngsrcset problem replaces solves src srcset string text url work write"
    }
  },
  ...
  "guide/databinding": {
    ...
    "searchTerms": {
      ...
      "keywords": "additional angular application apps automatic automatically bind binding browser change changes class classical code compilation compiled completely components constantly controller data data-binding databinding dependency developer differently direction directives docs dom easy greatly guide html _img implements instant isolation js-angular-release live markup merge model ngdoc occurs overview png produces programming projection propagated reflected reflects scope scopes sections separated simplifying simply single-source-of-truth snap src step synchronization syncs systems template templates templating test testing times topics treat unaware uncompiled user versa vice view work worse write"
    }
  },
  "guide/di": {
    "docType": "overview",
